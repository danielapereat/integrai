    ...
    return (
        <div className="h-screen">
            <header className="bg-white drop-shadow-md sticky top-0">
                <nav className=" mx-8 flex items-center justify-between p-6 lg:px-8" aria-label="Global">
            ...
            <div className="flex flex-row">
                <aside className="fixed shadow-md top-20 px-8 py-4 left-0 z-40 w-64 h-full">
                    <h1 className="text-2xl my-4 font-semibold leading-6 text-indigo-700">Integrations</h1>
                    <nav>
                        <div>
                            <p>Dummy Integration</p>
                        </div>
                    </nav>
                </aside>
